    ...
    <div className='bg-cover bg-center min-h-screen flex items-center justify-center' style={{ backgroundImage: "url('https://res.cloudinary.com/dl6mko7z1/image/upload/v1753079907/pexels-catscoming-406152_ecfpac.jpg')" }}>
      <div className='bg-[rgba(255,255,255,0.8)] flex flex-col justify-center p-12 min-h-[300px] rounded-md shadow-md w-full max-w-md'>
        ...
        <Form layout='vertical' align="middle">
          ...
          <Form.Item>
            <Button type='primary' htmlType='submit' loading={isProcessing} onClick={handleLogin} className="!bg-green-400 hover:!bg-green-300 duration-300 text-white w-[50%]">Login</Button>
          </Form.Item>
          <div className='text-xl'>Don't have an account  <Link to="/auth/register" className='!underline !text-green-500'>Register</Link></div>
        </Form>
      </div>
